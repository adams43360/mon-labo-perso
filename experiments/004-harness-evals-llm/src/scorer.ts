 ...
 * On évalue la classification, pas la propreté du formatage (cf. ARCHITECTURE.md).
 */
export function normalize(raw: string): Category | null {
  ...
  // Réponse verbeuse ("catégorie : relance") — on accepte si UNE seule catégorie apparaît
